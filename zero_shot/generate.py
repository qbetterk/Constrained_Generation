...
from zero_shot.topK import topk_huggingface, ConstrainedHypothesis
    ...
    while cur_len < max_length:
        ...
        for batch_idx in range(batch_size):
            ...
            for beam_token_rank, (beam_token_id, beam_token_score, constraint, num_met) in enumerate(
                ...
                beam_id = torch.div(beam_token_id, vocab_size, rounding_mode='trunc') # beam_token_id // vocab_size
